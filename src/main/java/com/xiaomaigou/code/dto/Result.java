...
public class Result<T> implements Serializable {
     ...
     * 返回代码,example = "200"
     */
    @ApiModelProperty(value = "返回代码,example = \"200\"", name = "code")
    private Integer code;

    /**
     * 返回消息,example = "success"
     */
    @ApiModelProperty(value = "返回消息,example = \"success\"", name = "msg")
    private String msg;

    /**
     * 返回数据,example="{name:"xiaomaigou"}"
     */
    @ApiModelProperty(value = "返回数据,example=\"{name:\"xiaomaigou\"}\"", name = "data")
    private T data;
