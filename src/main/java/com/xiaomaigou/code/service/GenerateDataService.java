...
public interface GenerateDataService {
     ...
     * @return 模板数据
     */
    TemplateData generateTemplateData(TableEntity tableEntity, List<ColumnEntity> columnEntityList);
     ...
     * @return 模板数据
     */
    List<TemplateData> generateTemplateData(List<String> tableNameList);
